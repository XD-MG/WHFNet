...
data_root = '/workspace/DATA/korea/256_cloud'
crop_size = (256, 256)
...
train_dataloader = dict(batch_size=4,
                        ...
                        dataset=dict(type=dataset_type,
                                     data_root=data_root,
                                     ann_file='/workspace/DATA/korea/256_cloud/listtxt/trainM.txt',
...
val_dataloader = dict(batch_size=1,
                      ...
                      dataset=dict(type=dataset_type,
                                   data_root=data_root,
                                   ann_file='/workspace/DATA/korea/256_cloud/listtxt/valM.txt',
                                   data_prefix=dict(img_path='GF2',
                                                    img_path2='GF3',
                                                    seg_map_path='label'),
